...
public class ClientApi {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(schema = @Schema(implementation = ClientDto.class)))
    @ApiResponses(value = {
    ...
    @PostMapping
    public SuccessClientCreateDto addNewClient(@Valid @RequestBody ClientDto clientDto){
    ...
    public void updateClient(@PathVariable(value = "client_id") Integer clientId, @Valid @RequestBody UpdateClientDto clientDto){
